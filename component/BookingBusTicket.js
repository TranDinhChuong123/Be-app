...
const ManHinhDatVeXe = () => {
  ...
  const [danhSachDiaDiem, setDanhSachDiaDiem] = useState([
    ...
    { id: '3', tenDiaDiem: 'Vũng Tàu, Bà Rịa - Vũng Tàu', anh: require('../assets/map.png') },
    ...
    <View style = {styles.container}>
      <View style = {styles.header}>
        <View style={{flex:1, flexDirection:'row'}}>
          <TouchableOpacity onPress={()=>{navigation.navigate('TrangChuTap')}}>
            <Image source={require('../assets/back.png')} style={{width: 30, height: 30, resizeMode:'center'}}/>
          </TouchableOpacity>
          <Text style={{fontSize: 20, fontWeight: 'bold', left: 5}}>Mua vé xe khách</Text>
        </View>
        <TouchableOpacity onPress={() => {navigation.navigate('Hoạt động')}}>
          <View>
            <Text style={{fontSize: 16, color: '#3399FF', fontWeight:'bold', right: 15}}>Vé của tôi</Text>
          </View>
        </TouchableOpacity>
      ...
      <View style={styles.inputtxt}>
        <View style={{flex: 1, flexDirection: 'row',  alignItems: 'center'}}>
          <Image style={{width: 20, height: 20, position: 'absolute', right: 328}} source={require('../assets/vaytay.png')}/>
          <TextInput style={{width: 350, height: 50, paddingLeft: 25, backgroundColor: '#FFFFFF'}}
        ...
        <View style={{flex: 1, flexDirection: 'row', alignItems: 'center'}}>
        <Image style={{width: 20, height: 20, position: 'absolute', right: 328 }} source={require('../assets/yellow_map.png')}/>
          <TextInput style={{width: 350, height: 50, paddingLeft: 25, backgroundColor: '#FFFFFF'}}
      ...
      <View style={styles.conten}>
        <Text style={{fontSize: 20, fontWeight: 'bold', color: '#BBBBBB', right: 40}}>Địa điểm phổ biến</Text>
        <Image style={{width: 30, height: 30, left: 30, top: 5}} source={require('../assets/len.png')}/>
      </View>
      <View style={styles.diadiem}>
        <ScrollView contentContainerStyle={{padding: 10,backgroundColor: "#EEEEEE", }} >
          <FlatList
            ...
            renderItem={({ item }) => (
              <View style={{flex: 1, flexDirection: 'row'}}>
                <Image style={{width: 50, height: 50, position: 'absolute'}} source={item.anh} />
                <TouchableOpacity style = {{width: 400, height: 50, backgroundColor: 'white', justifyContent: 'center', paddingLeft:10, left: 50}}  onPress={() => chonDiaDiem(item)}>
                  <Text style={{color: 'black', fontSize: 18, fontWeight: 'bold'}}>{item.tenDiaDiem}</Text>
                </TouchableOpacity>
              </View>
            )}
          />
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={styles.btnfooter} title="Đặt vé"  butom onPress={() => console.log('Đặt vé')} disabled={!diemDen || !diemXuatPhat}>
              <Text style={{color: 'black', fontSize: 18, fontWeight: 'bold'}}>Đặt vé</Text>
        </TouchableOpacity>
      </View>      
    </View>
  );
