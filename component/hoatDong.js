    ...
    return(
        <SafeAreaView style={styles.container}>
            ...
            {currentView === 'view2' && <View style = {styles.view}>
                    ...
                    {/* navigation đến trang đặt đồ ăn */}
                    <TouchableOpacity style={{backgroundColor: '#FFCC33',top: 15, width: 150, height: 50, justifyContent:'center', alignItems: 'center', borderRadius: 12}}>
                        <Text style={{fontSize: 20, fontWeight: 'bold', bottom: 2}}>Đặt ngay</Text>
                    </TouchableOpacity>
                </View>}
            ...
            {currentView === 'view3' && <View style = {styles.view}>
                    <Image source={require('../assets/airplane.png')} style={{width: 50, height: 50}}/>
                    ...
                    {/* navigation đến trang đặt vé máy bay */}
                    <TouchableOpacity style={{backgroundColor: '#FFCC33',top: 15, width: 150, height: 50, justifyContent:'center', alignItems: 'center', borderRadius: 12}}>
                        <Text style={{fontSize: 20, fontWeight: 'bold', bottom: 2}}>Đặt ngay</Text>
                    </TouchableOpacity>
                </View>}
            ...
            {currentView === 'view4' && <View style = {styles.view}>
                    <Image source={require('../assets/delivery.png')} style={{width: 50, height: 50}}/>
                    ...
                    {/* navigation đến trang giao/đặt hàng */}
                    <TouchableOpacity style={{backgroundColor: '#FFCC33',top: 15, width: 150, height: 50, justifyContent:'center', alignItems: 'center', borderRadius: 12}}>
                        <Text style={{fontSize: 20, fontWeight: 'bold', bottom: 2}}>Đặt ngay</Text>
                    </TouchableOpacity>
                </View>}
            ...
            {currentView === 'view5' && <View style = {styles.view}>
                    <Image source={require('../assets/be_bus.png')} style={{width: 50, height: 50}}/>
            ...
            {currentView === 'view6' && <View style = {styles.view}>
                    <Image source={require('../assets/bill_3g.png')} style={{width: 50, height: 50}}/>
