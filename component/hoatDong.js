    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <TouchableOpacity style={styles.btnView} onPress={switchToView1}>
          <Text style={{ fontSize: 16, fontWeight: "bold", color: "#999999" }}>
            Đặt xe
          </Text>
        </TouchableOpacity>
      ...
      {currentView === "view1" && (
        <View style={styles.view}>
          <Image
            source={require("../assets/motor_tick.png")}
            style={{ width: 150, height: 150 }}
          />
          <Text style={styles.txt}>Bạn chưa đặt chuyến xe nào. Đặt chuyến</Text>
          <Text style={styles.txt}>
            xe đầu tiên ngay và sử dụng nhiều ưu đãi
          </Text>
      ...
      {currentView === "view2" && (
        <View style={styles.view}>
          <Image
            source={require("../assets/eat_drink.png")}
            style={{ width: 150, height: 150 }}
          />
          <Text style={styles.txt}>
            Bạn chưa đặt món ăn nào. Hãy đặt beFood
          </Text>
      ...
      {currentView === "view3" && (
        <View style={styles.view}>
          ...
          <Text style={styles.txt}>
            chiếc vé đầu tiên để tận hưởng các ưu đãi
          </Text>
      ...
      {currentView === "view4" && (
        <View style={styles.view}>
          ...
          />
          <Text style={styles.txt}>
            Các đơn hàng trên 6 tháng sẽ được ẩn đi.
          </Text>
          <Text style={styles.txt}>
            Bạn vui lòng đặt đơn hàng mới và sử dụng nhiều
          </Text>
      ...
      {currentView === "view5" && (
        <View style={styles.view}>
          <Image
            source={require("../assets/be_bus.png")}
            style={{ width: 150, height: 150 }}
          />
          <Text style={styles.txt}>
            Bạn chưa đặt vé xe nào. Hãy đặt chiếc vé
          </Text>
      ...
      {currentView === "view6" && (
        <View style={styles.view}>
          <Image
            source={require("../assets/bill_3g.png")}
            style={{ width: 150, height: 150 }}
          />
          <Text style={styles.txt}>
            Bạn chưa có giao dịch điện thoại nào. Nạp
          </Text>
          <Text style={styles.txt}>
            tiền điện thoại ngay để nhận được chiết
          </Text>
